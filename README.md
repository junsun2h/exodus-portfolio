...
![인게임 — 메인 스테이지 104층](img/game-battle.webp)

<sub><b>실제 플레이 화면입니다.</b> 메인 스테이지 104층, 몬스터 20여 마리와 동시 교전 중입니다.
이 한 장에 리포의 여러 항목이 겹쳐 있습니다 — 동시 스폰 한계를 20에서 60으로 올린
<a href="F-46_대량몬스터스폰최적화/">F-46</a>, 피격 플래시·몸 진동·카메라 셰이크를 묶은
<a href="F-49_전투타격감연출/">F-49</a>, 화면에 떠 있는 데미지 숫자(315.06억)를 산출하는 MOD 수식 엔진
<a href="F-02_MOD전투수식엔진/">F-02</a>, 그리고 이 이펙트들을 재사용하는 풀링 계층
<a href="F-47_전투이펙트풀링복구/">F-47</a>.</sub>
