...
| 자동생성 코드 | **134,348줄** |
| 이 리포 수록 분량 | **81,281줄** / 275파일 / 32개 피처 (코드 70,332줄 + 실행 리포트·AI 자산 10,949줄) |
| 등록 Manager | 65개 |
...
[F-34 무인 감사](F-34_야간무인감사파이프라인/) → [F-35 동등성 골든 테스트](F-35_동등성골든테스트/) → [F-04 코드 생성 파이프라인](F-04_코드생성파이프라인/) → [F-06 서버 3계층 요청 템플릿](F-06_서버3계층요청템플릿/) → [F-07 HashPRNG 결정론 난수](F-07_HashPRNG최적화/)
...
| [F-49](F-49_전투타격감연출/) | 자동전투 타격감 연출 (플래시·몸 진동·카메라 셰이크) | P3 | 클라·TA | 5파일 / 1,373줄 |
| [F-50](F-50_AI워크플로우자산/) | AI 워크플로우 엔지니어링 자산 | P3 | TD | 22파일 / 3,518줄 |
